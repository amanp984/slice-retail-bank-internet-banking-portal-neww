...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Slice" },
      { name: "description", content: "A modern, responsive internet banking web application with a premium fintech UI." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Slice" },
      { property: "og:description", content: "A modern, responsive internet banking web application with a premium fintech UI." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Slice" },
      { name: "twitter:description", content: "A modern, responsive internet banking web application with a premium fintech UI." },
