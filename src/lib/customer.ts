...
export const PROFILES: Record<string, CustomerProfile> = {
  ...
  "355532486214": {
    username: "355532486214",
    password: "Ompra@1945",
    businessName: "Omprakash",
    holderName: "Omprakash",
    customerId: "355532486214",
    accountNumber: "033882417553692",
    accountType: "CURRENT",
    ifsc: "NESF0000333",
    micr: "3348764286",
    phone: "+91 64XXXXXX88",
    email: "Omprakasdubey7719@gmail.com",
    pan: "OMXXXXXX14P",
    aadhaarMasked: "XXXX XXXX 6214",
    nominee: "-",
    address:
      "Shiv Krupa Building, Hanuman Nagar Road, Badagaon Block, Mumbai - 400096",
    branch:
      "Slice Bank, Mumbai - Corporate Branch, Tower A, BKC, Mumbai, Maharashtra - 400051",
